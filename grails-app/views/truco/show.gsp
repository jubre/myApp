...
<html>
    ...
    <body>
        ...
        <div id="show-truco" class="content scaffold-show" role="main">
            ...
            <f:display bean="truco" />
            <g:form resource="${this.truco}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.truco}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
